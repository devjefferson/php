...
echo "<h1>Teste de Conectividade com o Banco de Dados</h1>";
...
try {
    ...
    echo "<h2>7. Verificar Tabela de Usuários</h2>";
    ...
    // 8. Verificar Extensão MySQL
    echo "<h2>8. Verificar Extensão MySQL</h2>";
    ...
    // 9. Verificar Versão do PHP
    echo "<h2>9. Informações do PHP</h2>";
...
// 10. Verificar Configurações do PHP
echo "<h2>10. Configurações do PHP</h2>";
echo "<pre>";
